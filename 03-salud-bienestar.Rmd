...
Los resultados de 2021 muestran que, si bien un 48,6% de la población no presenta o presenta síntomas mínimos de depresión (Figura 3.4), un alto porcentaje presenta síntomas depresivos, en distintos niveles de severidad. Un 32,6% de la población presenta sintomatología depresiva media, 11,2% síntomas depresivos moderados, y 7,7% de depresión moderada-severa a severa (Figura 3.4), lo que revela una alta prevalencia de este tipo de síntomas en la población general y confirma una deteriorada situación de la salud mental en Chile.
