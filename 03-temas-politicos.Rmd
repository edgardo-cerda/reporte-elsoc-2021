...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2021.\nNota: Se consideran observaciones con datos completos entre 2016 y 2021. N=1.513 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.443 (1.513 individuos)')
...
elsoc_wide_2016_2021 %>% 
  ...
  guides(fill = guide_legend(reverse = TRUE)) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=3.026 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.553 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  guides(fill = guide_legend(reverse = TRUE)) + 
  ggtitle(label = NULL) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.512 (1.512 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=2.931 (1.510 individuos)')
...
tab_5 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.335 (1.467 individuos)')
...
tip_par %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.175 (1.435 individuos)')
...
tip_par %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.235 (1.447 individuos)')
...
tip_par %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.225 (1.445 individuos)')
...
tip_par %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=6.820 (1.364 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  guides(color = guide_legend(reverse = TRUE)) +
  ggtitle(label = NULL) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=3.003 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.482 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.556 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  ggtitle(label = NULL,
          subtitle = 'Porcentaje que participa Frecuentemente o Muy frecuentemente') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.473 (1.513 individuos)')
...
sjlabelled::as_label(ola) %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=6.026 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL,
        subtitle = 'Porcentaje que responde que Muchas veces o Siempre se justifica' ) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.507 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.442 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  ggtitle(NULL,
          subtitle = 'Porcentaje que responde que...') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.507 (1.507 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.462 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggplot(aes(y = prop, x = ola, color = name, group = name,
    ...
    ggtitle(NULL,
          subtitle = 'Porcentaje que Confía Bastante o Mucho') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.456 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL,
          subtitle = 'Porcentaje que Confía Bastante o Mucho') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=2.954 (1.509 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.208 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  ggtitle(NULL,
        subtitle = 'Porcentaje que responde...') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.443 (1.443 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  ggtitle(NULL,
        subtitle = 'Porcentaje que responde...') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.458 (1.458 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=4.179 (1.511 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=954 (954 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.414 (1.513 individuos)')
...
elsoc_wide_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=4.401 (1.467 individuos)')
...
elsoc_wide_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=2.792 (1.396 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.405 (1.405 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.377 (1.377 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL,
        subtitle = 'Porcentaje de acuerdo o muy de acuerdo en promedio con atributos positivos') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.382 (1.382 individuos)')
