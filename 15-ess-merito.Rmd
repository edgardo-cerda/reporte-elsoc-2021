...
elsoc_movilidad$m_mov_social <- round(elsoc_movilidad$m_mov_social, digits = 2) 

g11.6 <- 
  ggplot(elsoc_movilidad, aes(y = m_mov_social, x = ola, group = value, color = value,
                              label = m_mov_social)) +
  theme_bw() +
  geom_line(size = 1) +
  geom_point(size = 1.8) +
