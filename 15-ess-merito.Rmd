...
datos.grafico.g11.7 <- cbind(datos.esfu, datos.inte, datos.educ, datos.trab)

#trasponer según variable
datos.grafico.g11.7.a <- datos.grafico.g11.5 %>% 
...
datos.grafico.g11.7.a$porcentaje <- with(datos.grafico.g11.5.a, case_when(
...
subset.g11.7 <- droplevels(subset(datos.grafico.g11.5.a, value == 'De acuerdo o totalmente de acuerdo'))
