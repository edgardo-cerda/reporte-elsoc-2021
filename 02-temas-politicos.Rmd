...
tab_3$Clase  <- factor(tab_3$Clase, levels = c(1,2,3), labels = c("(18.2%)", "(53.92%)", "(27.88%)"))
...
tab_3 %>% ggplot(aes(x = freq, y = var, fill = Participa)) + 
  ...
  theme_bw() + theme(legend.position = "bottom", plot.title = element_text(size=14))
...
tab_4$Clase  <- factor(tab_4$Clase, levels = c(1,2,3,4), labels = c("(50.78%)", "(17.11%)", "(9.88%)", "(22.22%)"))
...
tab_5$Clase  <- factor(tab_5$Clase, levels = c(1,2,3,4,5), labels = c("(24.06%)", "(16.22%)", "(5.11%)", "(47.1%)", "(7.5%)"))
