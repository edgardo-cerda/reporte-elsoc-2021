...
```{r tip-participacion, fig.cap = 'Perfiles de participación política'}
...
ggplot(aes(x = freq, y = class_part_4, fill = pos_id, label = scales::percent(freq, .1))) + 
  geom_bar(stat = 'identity', position = 'stack') +
  labs(y=" ", x=" ",
       title = "Posición política según perfil de participación", fill = "") +
  scale_x_continuous(labels = scales::percent, limits = c(0, 1)) +
  guides(fill = guide_legend(reverse = TRUE)) +
...
ggplot(aes(x = freq, y = class_part_4, fill = pos_id, label = scales::percent(freq, .1))) + 
  geom_bar(stat = 'identity', position = 'stack') +
  labs(y="", x="",
       title = "Sexo según perfil de participación", fill = "") +
  scale_x_continuous(labels = scales::percent, limits = c(0, 1)) +
  guides(fill = guide_legend(reverse = TRUE)) +
...
ggplot(aes(x = freq, y = class_part_4, fill = pos_id, label = scales::percent(freq, .1))) + 
  geom_bar(stat = 'identity', position = 'stack') +
  labs(y="", x="",
       title = "Edad según perfil de participación", fill = "") +
  scale_x_continuous(labels = scales::percent, limits = c(0, 1)) +
  guides(fill = guide_legend(reverse = TRUE)) +
  geom_text(position = position_stack(vjust = .5), size = 3,
            color = rep(c('white', 'white', 'black', 'black'), 4)) +
...
ggplot(aes(x = freq, y = class_part_4, fill = pos_id, label = scales::percent(freq, .1))) + 
  geom_bar(stat = 'identity', position = 'stack') +
  labs(y="", x="",
       title = "Interés en la política según perfil de participación", fill = "") +
  scale_x_continuous(labels = scales::percent, limits = c(0, 1)) +
  guides(fill = guide_legend(reverse = TRUE)) +
  geom_text(position = position_stack(vjust = .5), size = 3,
...
ggplot(aes(x = freq, y = class_part_4, fill = pos_id, label = scales::percent(freq, .1))) + 
  geom_bar(stat = 'identity', position = 'stack') +
  labs(y="", x="",
       title = "Satisfacción con la democracia según perfil de participación", fill = "") +
  scale_x_continuous(labels = scales::percent, limits = c(0, 1)) +
  guides(fill = guide_legend(reverse = TRUE)) +
  geom_text(position = position_stack(vjust = .5), size = 3,
            color = rep(c('white', 'white', 'black'), 4)) +
...
ggplot(aes(x = freq, y = class_part_4, fill = pos_id, label = scales::percent(freq, .1))) + 
  geom_bar(stat = 'identity', position = 'stack') +
  labs(y="", x="",
       title = "Legitimidad democrática según perfil de participación", fill = "") +
  scale_x_continuous(labels = scales::percent, limits = c(0, 1)) +
  guides(fill = guide_legend(reverse = TRUE)) +
  geom_text(position = position_stack(vjust = .5), size = 2,
            color = rep(c('white', 'white', 'black', 'black'), 4)) +
...
ggplot(aes(x = freq, y = class_part_4, fill = pos_id, label = scales::percent(freq, .1))) + 
  geom_bar(stat = 'identity', position = 'stack') +
  labs(y="", x="",
       title = "Optimismo constitucional según perfil de participación", fill = "") +
  scale_x_continuous(labels = scales::percent, limits = c(0, 1)) +
  guides(fill = guide_legend(reverse = TRUE)) +
  geom_text(position = position_stack(vjust = .5), size = 3,
            color = rep(c('white', 'black'), 4)) +
