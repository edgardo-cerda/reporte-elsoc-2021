...
tab_4$Clase  <- factor(tab_4$Clase, levels = c(1,2,3,4), labels = c("Movilizados (16.77%)", "Desinteresados (58.9%)", "Reclutados (4.84%)", "Institucionales (19.5%)"))
...
tip_par$class_part_4  <- factor(tip_par$class_part_4, levels = c(1,2,3,4), labels = c("Movilizados", "Desinteresados", "Reclutados", "Institucionales"))
