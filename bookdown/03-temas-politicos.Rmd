...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.565 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.443 (1.513 individuos)')
...
elsoc_wide_2016_2021 %>% 
  ...
  guides(fill = guide_legend(reverse = TRUE)) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.026 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.553 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  guides(fill = guide_legend(reverse = TRUE)) + 
  ggtitle(label = NULL) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.512 (1.512 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=2.931 (1.510 individuos)')
...
tab_5 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.335 (1.467 individuos)')
...
```{r tipos-posicion-politica2, fig.cap = 'Perfil de participación según posición política'}
...
tip_par %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.175 (1.435 individuos)')
...
```{r tipos-sexo2, fig.cap = 'Perfil de participación según sexo'}
...
```{r tipos-edad2, fig.cap = 'Perfil de participación según edad'}
...
```{r tipos-educ2, fig.cap = 'Perfil de participación según educación'}
...
tip_par %>% 
  ...
  drop_na(c("class_part_5", "c15_w05")) %>%
  filter(tipo_atricion == 1) %>%
   mutate(pos_id = factor(car::recode(m01_w05, recodes = "1:3 = 1; 4:5 = 2; 6:7 = 3; 8:10 = 4"),
                   levels = 1:4,
...
```{r tipos-interes2, fig.cap = 'Perfil de participación según interés en la política'}
...
```{r tipos-satisfaccion2, fig.cap = 'Perfil de participación según satisfacción con la democracia'}
...
tip_par %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.235 (1.447 individuos)')
...
```{r tipos-legitimidad2, fig.cap = 'Perfil de participación según legitimidad democrática'}
...
tip_par %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.225 (1.445 individuos)')
...
```{r tipos-optimismo2, fig.cap = 'Perfil de participación según optimismo constitucional'}
...
tip_par %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=6.820 (1.364 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  guides(color = guide_legend(reverse = TRUE)) +
  ggtitle(label = NULL) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.003 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.482 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.556 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  ggtitle(label = NULL,
          subtitle = 'Porcentaje que participa Frecuentemente o Muy frecuentemente') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.473 (1.513 individuos)')
...
sjlabelled::as_label(ola) %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=6.026 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.442 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggplot(aes(y = prop, x = ola, color = name, group = name,
    ...
    ggtitle(NULL,
          subtitle = 'Porcentaje que Confía Bastante o Mucho') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.456 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL,
          subtitle = 'Porcentaje que Confía Bastante o Mucho') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=2.954 (1.509 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.208 (1.513 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  ggtitle(NULL,
        subtitle = 'Porcentaje que responde...') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.443 (1.443 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  ggtitle(NULL,
        subtitle = 'Porcentaje que responde...') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.458 (1.458 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=4.179 (1.511 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=954 (954 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.414 (1.513 individuos)')
...
elsoc_wide_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=4.401 (1.467 individuos)')
...
elsoc_wide_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=2.792 (1.396 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.405 (1.405 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.377 (1.377 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL,
        subtitle = 'Porcentaje de acuerdo o muy de acuerdo en promedio con atributos positivos') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.382 (1.382 individuos)')
