...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.498 (1.498 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL, 'Porcentaje que responde que...') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.508 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  geom_text(position = position_dodge2(.9),
    ...
    theme(plot.caption = element_text(hjust = 0),
          legend.position = 'none') +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.513 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  scale_color_viridis_d(begin = 0, end = .8, direction = -1) +
    theme(plot.caption = element_text(hjust = 0),
          legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.489 (1.489 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  geom_text(data = function(x) { group_by(.data = x, ola, depr) %>%
      ...
      color = rep(c('black', 'black', 'white', 'white'), 5),
            size = 3) + 
  guides(fill = guide_legend(reverse = TRUE)) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.451 (1.513 individuos)')
...
elsoc_depr_lca %>% 
  ...
  prop_list(depr_w01, depr_w02, depr_w03, depr_w04, depr_w05, 
    ...
    scale_fill_viridis_d(end = .85) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=7.045 (1.409 individuos)')
...
elsoc_depr_lca %>%
  filter(tipo_atricion == 1, !is_nsnr(m30b_w05, m54_w05)) %>%
  mutate(m30b_w05 = as.numeric(car::recode(m30b_w05, "1 = 170000; 2 = 300000; 3 = 400000; 4 = 600000; 5 = 1200000; NA = NA")),
         m29_imp_w05 = ifelse(!is_nsnr(m29_w05), m29_w05, m30b_w05),
         nhogar_w05 = m54_w05,
         ypc = m29_imp_w05 / nhogar_w05,
         quintil = xtile(ypc, n = 5, wt = ponderador02_w05),
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank())  +
  guides(fill = guide_legend(reverse = TRUE)) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=6.950 (1.390 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  geom_text(vjust = -0.5,
    ...
    theme(plot.caption = element_text(hjust = 0),
          legend.position = 'top', legend.title = element_blank()) + 
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.511 (1.511 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
          legend.position = 'top',
        legend.title = element_blank()) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=4.354 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        ...
        legend.title = element_blank()) + 
  ggtitle(label = NULL) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=3.018 (1.509 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.508 (1.508 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.505 (1.505 individuos)')
...
elsoc_long_2016_2021 %>% 
  dplyr::filter(ola == 5, tipo_atricion == 1, !is_nsnr(s31, c48)) %>%
  mutate(c48 = factor(car::recode(c48, "1:2 = 1; 3 = 2; 4:5 = 3"),
                               levels = 1:3,
                               labels= c("Nunca o casi nunca", "A veces",
                                         "Frecuentemente o\nmuy frecuentemente"))) %>%
  ...
  geom_text(vjust = -0.5,
            ...
            size = 3)  +
  theme(plot.caption = element_text(hjust = 0)) +
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Se consideran observaciones de individuos sin atrición entre olas. N=1.510 (1.510 individuos)')
