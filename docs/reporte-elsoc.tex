...
\hypersetup{
  pdftitle={Radiografía del cambio social 2016-2021},
  pdfauthor={González, R; Bargsted, M; Figuereido, A; Miranda, D; Cerda, E; Plaza, A; Salas, R},
  colorlinks=true,
  linkcolor=blue,
  filecolor=Maroon,
  citecolor=Blue,
...
\title{Radiografía del cambio social 2016-2021}
\usepackage{etoolbox}
\makeatletter
...
\author{González, R; Bargsted, M; Figuereido, A; Miranda, D; Cerda, E; Plaza, A; Salas, R}
\date{}
...
{\centering \includegraphics{reporte-elsoc_files/figure-latex/dias-cuarentena-1} 
