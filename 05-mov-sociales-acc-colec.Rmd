...
#### ¿Cuál es el movimiento social que usted más valora de esta lista? Según ola del estudio
...
#### Frecuencia de respuesta en "ninguno" ante la pregunta ¿Cuál es el movimiento social que usted más valora de esta lista? según posición política"
...
elsoc_long_2016_2021 %>%
  ...
  geom_text_repel(color = viridis(1)) + 
  ylab(label = NULL) +
  xlab(label = NULL) +
...
elsoc_long_2016_2021 %>%
  ...
  ylab(label = NULL) +
  xlab(label = NULL) +
  scale_color_viridis_d(begin = 0, end = .75, direction = -1, option = 'viridis') +
  theme(legend.position = 'top',
        legend.title = element_blank())
