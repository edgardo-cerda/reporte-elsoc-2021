...
```{r deuda-phq, fig.align='center',fig.cap="Deuda según ola y Sintomas Depresivos", eval=FALSE, include=FALSE}
#este grafico no logra explicar mucho... quizás eliminarlo
