...
# Estimaciones de EGP
elsoc_egp <- sjlabelled::read_data(file.path('inputs', 'elsoc_egp.dta'))
...
rm(list = setdiff(ls(), c('elsoc_long_cuarentenas', 'elsoc_egp', 'elsoc_long_2016_2021', 'elsoc_wide_2016_2021')))
