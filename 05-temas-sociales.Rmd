...
elsoc_long_2016_2021 %>% 
  ...
  geom_text(position = position_stack(vjust = .5),
            size = 3, color = rep(c('black', 'white', 'white'), 5)) + 
  theme(plot.caption = element_text(hjust = 0),           legend.position = 'top', 
        legend.title = element_blank()) +
  
  labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=4.536 (1.513 individuos)')
...
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=3.013 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL,
          subtitle = 'Porcentaje con conflictos barriales "Siempre" o "Muchas veces"') +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=2.978 (1.511 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.529 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  geom_text(vjust = -0.8,
    ...
    ggtitle(NULL,
          'Porcentaje que confía Bastante o Mucho en sus vecinos') +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=3.011 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL,
          'Porcentaje que confía Bastante o Mucho en sus vecinos') +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.308 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.557 (1.513 individuos)')
...
tab %>%
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.832 (548 individuos)')
...
territorial %>%   
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021 y Datos territoriales ELSOC 2017.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.515 (1.503 individuos)')
...
tab %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021 y Datos territoriales ELSOC 2017.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.485 (1.497 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank())  +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.560 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL,
          'Porcentaje que se siente Inseguro o Muy inseguro') +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.558 (1.513 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  ggtitle(NULL,
          'Porcentaje que se siente Inseguro o Muy inseguro') +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=2.901 (1.198 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top', 
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.169 (1.513 individuos)')
...
```{r crim-zona, fig.cap = '¿Con qué frecuencia se han producido crímenes (riñas, robos y tráfico de drogas) en su barrio?, según ola del estudio y zona geográfica. Porcentaje de experiencias de criminalidad "Siempre" o "Muchas veces".'}
...
elsoc_long_2016_2021 %>% 
  ...
  geom_text(vjust = -0.8,
            position = position_dodge(width = .9),
            size = 3) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=2.868 (1.503 individuos)')
...
```{r crim-estrato, fig.cap = '¿Con qué frecuencia se han producido crímenes (riñas, robos y tráfico de drogas) en su barrio?, según ola del estudio y tipo de ciudad. Porcentaje de experiencias de criminalidad "Siempre" o "Muchas veces".'}
...
```{r crim-quintil, fig.cap = '¿Con qué frecuencia se han producido crímenes (riñas, robos y tráfico de drogas) en su barrio?, según ola del estudio y quintil de ingreso. Porcentaje de experiencias de criminalidad "Siempre" o "Muchas veces".'}
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=2.795 (1.201 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=10.229 (2.446 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=10.208 (2.446 individuos)')
...
elsoc_long_2016_2021 %>%
  ...
  geom_text(vjust = -0.8,
            position = position_dodge(width = .9),
            size = 3) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=2.416 (2.416 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=9.831 (2.444 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=9.381 (2.444 individuos)')
...
```{r sexismo-sexo, fig.cap = 'Sexismo benévolo y hostil, según sexo (2021). Porcentaje que responde "De acuerdo" o "Totalmente de acuerdo".'}
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank())   +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.473 (1.473 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.537 (1.513 individuos)')
...
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=4.491 (1.499 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.490 (1.490 individuos)')
...
elsoc_long_2016_2021 %>% 
  ...
  theme(plot.caption = element_text(hjust = 0),
        legend.position = 'top',
        legend.title = element_blank()) +
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=1.484 (1.484 individuos)')
...
```{r merit-wave, fig.align='center',fig.cap = 'Percepción de importancia y recompensas del mérito, según ola de estudio'}
...
labs(caption = 'Fuente: Elaboración propia en base a datos ELSOC 2016-2021.\nNota: Solo se consideran observaciones de individuos sin atrición entre olas. N=7.490 (1.513 individuos)')
