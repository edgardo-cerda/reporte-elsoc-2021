...
## Roles de Género
```{r c19_01, fig.align='center', fig.cap='Sexismo hostil c19_01, según ola y sexo.'}
#1
...
```{r c19_02, fig.align='center', fig.cap='Sexismo hostilc19_02, según ola y sexo.'}
...
```{r c19_03, fig.align='center', fig.cap='Sexismo hostil c19_03, según ola y sexo.'}
...
```{r c19_04, fig.align='center', fig.cap='Sexismo hostil c19_04, según ola y sexo.'}
...
datos.g16.9 <- elsoc_long_2016_2021 %>% 
  ...
  dplyr::filter(tipo_atricion == 1 
                & !ola %in% c(1,2,4) & !is.na(empleo)) %>% 
  prop(empleo, by = c(ola,m0_sexo), na.rm = TRUE, vartype = NULL) %>% 
  sjlabelled::as_label(m0_sexo, ola, empleo) 

g16.9 <- datos.g16.9 %>% 
  ggplot(aes(y = prop, x = m0_sexo, fill = empleo, 
